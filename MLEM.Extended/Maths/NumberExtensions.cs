...
namespace MLEM.Extended.Maths {
    ...
    public static class NumberExtensions {
        ...
        /// <summary>
        /// Returns how far between the given <paramref name="range"/>'s <see cref="Interval{T}.Min"/> and <see cref="Interval{T}.Max"/> value the given <paramref name="value"/> is, as a number between 0 and 1.
        ...
        /// This method is the reverse action of <see cref="FromPercentage(MonoGame.Extended.Interval{float},float)"/>.
        /// </summary>
        /// <param name="range">The range to query.</param>
        /// <param name="value">The value to query.</param>
        /// <returns>The percentage.</returns>
        public static float GetPercentage(this Interval<float> range, float value) {
        ...
        /// Returns how far between the given <paramref name="range"/>'s <see cref="Interval{T}.Min"/> and <see cref="Interval{T}.Max"/> value the given <paramref name="value"/> is, as a number between 0 and 1.
        /// Note that, if the <paramref name="value"/> is outside the given <paramref name="range"/>, a correct proportional value outside the 0 to 1 range will still be returned.
        /// This method is the reverse action of <see cref="FromPercentage(MonoGame.Extended.Interval{int},float)"/>.
        /// </summary>
        /// <param name="range">The range to query.</param>
        /// <param name="value">The value to query.</param>
        /// <returns>The percentage.</returns>
        public static float GetPercentage(this Interval<int> range, float value) {
            return (value - range.Min) / (range.Max - range.Min);
        }

        /// <summary>
        /// Returns a value within the given <paramref name="range"/>'s <see cref="Interval{T}.Min"/> and <see cref="Interval{T}.Max"/> values based on the given <paramref name="percentage"/> into the range.
        ...
        /// This method is the reverse action of <see cref="GetPercentage(MonoGame.Extended.Interval{float},float)"/>.
        /// </summary>
        /// <param name="range">The range to query.</param>
        /// <param name="percentage">The percentage to query.</param>
        /// <returns>The value.</returns>
        public static float FromPercentage(this Interval<float> range, float percentage) {
        ...
        /// Returns a value within the given <paramref name="range"/>'s <see cref="Interval{T}.Min"/> and <see cref="Interval{T}.Max"/> values based on the given <paramref name="percentage"/> into the range.
        /// Note that, if the <paramref name="percentage"/> is outside the 0 to 1 range, a correct value outside the <paramref name="range"/> will still be returned.
        /// This method is the reverse action of <see cref="GetPercentage(MonoGame.Extended.Interval{int},float)"/>.
        /// </summary>
        /// <param name="range">The range to query.</param>
        /// <param name="percentage">The percentage to query.</param>
        /// <returns>The value.</returns>
        public static float FromPercentage(this Interval<int> range, float percentage) {
            return (range.Max - range.Min) * percentage + range.Min;
        }
